...
contract MinterGuruCollectionsAccessToken is ERC721Enumerable, AccessControl, Ownable {
    ...
    /// Emits CollectionPurchased event
    function purchasePrivateCollection(
        ...
        MinterGuruPrivateCollection(instance).initialize(name, symbol,
